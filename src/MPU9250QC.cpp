/*
  ...
  YOU HAVE TO Calibrate your MPU9250 otherwise no sensible results will come out of it. This code is great in that
  it will compensenate your heading using the roll and pitch values of the MPU9250. Without this compensation again
  the results will be all over the place.

  To calibrate your device (TASK=1):

  - Connect your ESP8266 + MPU9250 to Visual Source Code
  - Call this library with TASK=1 (See example main.cpp file)
  - Run the Code whilst monitoring your Serial Monitor, at the right time move the sensor in a figure of 8 for 30 seconds
  - Copy the results from your serial monitor into the code
  - Change the code back to TASK=6 (you can have an LCD display but you don't need it)
...
void MPU9250::read_values()
{
  ...
  //  Serial.printf("LdB: read_values Task: %d - Count: %ld\n", TASK,count);
